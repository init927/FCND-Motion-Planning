...
from planning_utils import a_star, heuristic, create_grid, prune_path, local_to_global
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        waypoints = [[p[0] + north_offset, p[1] + east_offset, TARGET_ALTITUDE, 0] for p in p1]
        # Set self.waypoints
